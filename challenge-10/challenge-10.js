...
*/
 isOperatorValid = function isOperatorValide(op){
...
calculator = function calculator(oper){
...
*/
showOperationMessage = function showOperationMessage(operator,n1,n2){
...
*/
showErrorMessage = function showErrorMessage(operator){
...
*/
var subtraction = "-";
var sum = calculator(subtraction);
if(sum){
	console.log(showOperationMessage(subtraction,number1,number2),sum(number1,number2));
}else{
...
*/
var invalid = "x";
var sum = calculator(invalid);
if(sum){
	console.log(showOperationMessage(invalid,number1,number2),sum(number1,number2));
}else{
