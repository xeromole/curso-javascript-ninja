...
console.log(text.replace(/Manuel Marques de Sousa/,"Tiago Alves de Oliveira!"));
...
console.log(text.replace(/brasileiro/,"bahiano"))
...
console.log(text.replace(/O Centauro de Luvas/,function(valor,a){
...
function getMounthNumber(nameMounth){
	switch (nameMounth){
		...
		default: return  "Valor não definido"
	}
};
console.log("O mês de Janeiro é representado pelo número ", getMounthNumber("março"));
console.log("O mês de setembro é representado pelo número ", getMounthNumber("setembro"));
console.log("O mês de dezembro é representado pelo número ", getMounthNumber("dezembro"));
...
*/
console.log( '\nReplace de datas:' );
function replaceDate(regex,date,mounth,year){
	return  date+"/"+getMounthNumber(mounth)+"/"+year;
