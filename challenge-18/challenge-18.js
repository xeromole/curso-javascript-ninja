...
console.log( 'Limpando CPFs:' );
	...
	arrayCpf.forEach(function(item){
...
var matches = "Os meses de janeiro, junho e julho começam com a letra j.";
console.log(matches.match(/ju[nl]ho/g));
...
matches = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
console.log(matches.match(/<\w+>/g));
...
var matches = "<div><ul><li></li><li></li><li><span></span></li></ul></div>"
console.log(matches.match(/<\w+><\/\w+>/g));
...
var textMatch = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
var desafio =  textMatch.replace(/(<\w+>)(.+?)(<\/\w+>)/g,function(value,tagBegginer,text,tagEndder){
	tagBegginer === `<h1>` ? console.log(`${tagBegginer}O texto dentro da tag "h1" é ${text} ${tagEndder}`) : "";
	tagBegginer === `<p>` ? console.log(`${tagBegginer}O texto dentro da tag "h1" é ${text} ${tagEndder}`) : "";
	tagBegginer === `<footer>` ? console.log(`${tagBegginer}O texto dentro da tag "h1" é ${text} ${tagEndder}`) : "";
