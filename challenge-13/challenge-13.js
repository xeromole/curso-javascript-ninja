...
console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?' );
	 ...
	 var verifique = brasil.every(function(item){
	 	return item.length  > 7;
	 });
	 verifique === true ? console.log("Sim, todos os estados tem mais de 7 letras!") : console.log("Nem todos os estados tem mais de 7 letras!");
...
verifique = brasil.some(function(item){
	return item === "Ceará";
});
verifique === true ? console.log("Ceará está incluído!") : console.log("Ceará não foi incluído :(");
